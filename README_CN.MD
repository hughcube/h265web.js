...
>
> 本仓库是 [上游仓库](https://github.com/numberwolf/h265web.js) 的 **fork**。播放器、解码器和 wasm 等核心工作版权归原仓库作者所有。
>
...
>
> **许可证**：不变。仍适用 `CYL_Free-1.0` 协议，详见 `LICENSE-Free_CN.MD` / `LICENSE-Free_EN.MD`。所有权利按该协议第三部分归原仓库作者所有。
>
