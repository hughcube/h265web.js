...
>
> This repository is a **fork** of the [upstream repository](https://github.com/numberwolf/h265web.js). All credit for the player, decoder and wasm work goes to the original repo author.
>
